...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants: Record<string, string> = {
    ...
    secondary:
      "bg-gray-100 text-gray-900 hover:bg-gray-200 focus:ring-gray-300 disabled:opacity-50 disabled:cursor-not-allowed",
    ghost:
      "bg-transparent text-gray-900 hover:bg-gray-100 focus:ring-gray-300 disabled:opacity-50 disabled:cursor-not-allowed",
  };
